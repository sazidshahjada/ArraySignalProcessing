...
if __name__ == "__main__":
    ...
    visualize_consecutive_lags(
        ...
        save_path='figures/consecutive_lags_catarcs_model_visualization.png',
        show=True
        )
